var COS = require('./cos-wx-sdk-v5.1');
...
var _ugcUploader = {
    start: function(opts) {
        ...
        if (!Util.isFunction(opts.getSignature) || !Util.isFunction(opts.success) || !Util.isFunction(opts.error) || !Util.isFunction(opts.progress) || !Util.isFunction(opts.finish)) {
            wx.showToast({
